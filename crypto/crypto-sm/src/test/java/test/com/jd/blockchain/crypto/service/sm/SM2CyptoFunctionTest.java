...
public class SM2CyptoFunctionTest {
	...
	public void testEncryptionAndDecryption() {
		...
		AsymmetricEncryptionFunction asymmetricEncryptionFunction = Crypto.getAsymmetricEncryptionFunction(algorithm);
		...
		assertEquals(SM2Utils.POINT_SIZE + SM2Utils.SM3DIGEST_LENGTH + data.length, cipherBytes.length);
