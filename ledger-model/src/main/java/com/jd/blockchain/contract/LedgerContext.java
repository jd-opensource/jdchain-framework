...
import com.jd.blockchain.transaction.ContractEventOperator;
import com.jd.blockchain.transaction.ContractOperator;
 ...
 * 关于多账本（跨账本）需要再仔细设计；
 */
public interface LedgerContext extends BlockchainQueryService, UserOperator, DataAccountOperator, CommonEventOperator, LedgerQueryService, MetaInfoOperator, ContractEventOperator, ContractOperator {
